...
```{r}
ggplot(helmet) + geom_boxplot(aes(x=porosity,y=stiffFrac,fill=chemIndex)) + labs(y="Stiffness Fraction",x="Porosity", fill="Chemical Index")
ggplot(helmet) + geom_boxplot(aes(x=porosity,y=stiffness,fill=chemIndex)) +labs(y="Stiffness",x="Porosity", fill="Chemical Index")


```

## Damping Fraction Boxplots
```{r}
ggplot(helmet) + geom_boxplot(aes(x=porosity,y=dampFrac,fill=chemIndex)) + labs(y="Damping Fraction",x="Porosity", fill="Chemical Index")
```
...
## Damping Fraction EDA

```{r}
ggpairs(helmet[,c(4:7,13,15)])
```
