...
# Analysis ideas
For damping
- binned damping seems like a good idea
- logistic regression... does it extend to more than 2 levels?
- Some type of clustering algorithm
- PCA! What combo of variables is most important to predict damping

For stiffness
- more typical linear model
- interaction term for stress and strain??
- binned strain? (does this make sense scientifically?)
